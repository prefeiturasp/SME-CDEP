...
namespace SME.CDEP.Infra
{
    public abstract class WorkerRabbitCDEP : IHostedService
    {
        ...
        protected WorkerRabbitCDEP(IServiceScopeFactory serviceScopeFactory,
            ...
            bool retryAutomatico = true)
        {
            ...
            this.apmTransactionType = apmTransactionType ?? "WorkerRabbitCDEP";
        ...
        public Task StartAsync(CancellationToken stoppingToken)
        {
            ...
            RegistrarConsumerCDEP(consumer, tipoRotas);
            return Task.CompletedTask;
        }
        private void RegistrarConsumerCDEP(EventingBasicConsumer consumer, Type tipoRotas)
        {
            foreach (var fila in tipoRotas.ObterConstantesPublicas<string>())

...
namespace SME.CDEP.Worker
{
    public sealed class WorkerRabbitMQ : WorkerRabbitCDEP
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbit.ExecutarAtualizacaoSituacaoParaEmprestimoComDevolucaoEmAtraso, new ComandoRabbit("Atualizar situação para empréstimo com devolução em atraso", typeof(INotificarViaEmailCancelamentoAtendimento), true));
        }
    }
}
...
public class MensagemNegocio
{
    ...
    public const string CAMPO_X_ESPERADO_NUMERICO_E_COM_CASAS_DECIMAIS = "É esperado que o campo '{0}' seja numérico, com até 6 caracteres e esteja formatado como '###,##'.";
    ...
    public const string DATA_DA_DEVOLUCAO_MENOR_DATA_DO_EMPRESTIMO = "A 'Data da devolução' não pode ser menor ou igual a 'Data do empréstimo'.";
    ...
    public const string PERMITIDO_FINALIZAR_ATENDIMENTO_AGUARDANDO_VISITA_ATE_O_DIA_DE_HOJE = "Somente é permitido finalizar itens que foram agendados visita com data até o dia de hoje";

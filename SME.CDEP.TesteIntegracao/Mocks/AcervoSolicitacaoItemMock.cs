...
public class AcervoSolicitacaoItemMock : AuditoriaMock
{
    ...
    public Faker<AcervoSolicitacaoItem> Gerar(long acervoSolicitacaoId, TipoAtendimento tipoAtendimento,DateTime dataVisita)
    {
        ...
        faker.RuleFor(x => x.Situacao, f => SituacaoSolicitacaoItem.AGUARDANDO_ATENDIMENTO);

...
namespace SME.CDEP.TesteIntegracao.Usuario
{
    public class Ao_fazer_manutencao_material : TesteBase
    {
        ...
        public async Task Inserir()
        {
            ...
            var material = await servicoMaterial.Inserir(new IdNomeExcluidoTipoDto(){Nome = ConstantesTestes.APOSTILA});
        ...
        public async Task Nao_deve_para_cadastros_duplicados()
        {
            ...
            await servicoMaterial.Inserir(new IdNomeExcluidoTipoDto(){Nome = ConstantesTestes.APOSTILA, Tipo = (int)TipoMaterial.DOCUMENTAL}).ShouldThrowAsync<NegocioException>();
        }

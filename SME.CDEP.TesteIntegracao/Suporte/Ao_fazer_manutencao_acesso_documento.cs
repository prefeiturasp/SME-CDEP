...
namespace SME.CDEP.TesteIntegracao.Usuario
{
    public class Ao_fazer_manutencao_suporte : TesteBase
    {
        ...
        public async Task Inserir()
        {
            ...
            var suporte = await servicoSuporte.Inserir(new BaseComNomeTipoDto(){Nome = ConstantesTestes.DIGITAL_E_FISICO, Tipo = (int)TipoSuporte.VIDEO});
        ...
        public async Task Nao_deve_para_cadastros_duplicados()
        {
            ...
            await servicoSuporte.Inserir(new BaseComNomeTipoDto(){Nome = ConstantesTestes.PAPEL, Tipo = (int)TipoSuporte.IMAGEM}).ShouldThrowAsync<NegocioException>();
        }

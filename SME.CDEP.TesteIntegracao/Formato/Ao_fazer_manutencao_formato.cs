...
namespace SME.CDEP.TesteIntegracao.Usuario
{
    public class Ao_fazer_manutencao_formato : TesteBase
    {
        ...
        public async Task Inserir()
        {
            ...
            var formato = await servicoFormato.Inserir(new IdNomeExcluidoTipoDto(){Nome = ConstantesTestes.PAPEL});
        ...
        public async Task Nao_deve_para_cadastros_duplicados()
        {
            ...
            await servicoFormato.Inserir(new IdNomeExcluidoTipoDto(){Nome = ConstantesTestes.VOB,Tipo = (int)TipoFormato.ACERVO_AUDIOVISUAL}).ShouldThrowAsync<NegocioException>();
        }

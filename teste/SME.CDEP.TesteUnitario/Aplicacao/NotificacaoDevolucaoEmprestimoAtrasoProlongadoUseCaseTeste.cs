...
{
    public class NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCaseTeste
    {
        private readonly Mock<IServicoAcervoEmprestimo> _servicoAcervoEmprestimoMock;
        private readonly NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase _useCase;

        public NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCaseTeste()
        {
            var mocker = new AutoMocker();
            _servicoAcervoEmprestimoMock = mocker.GetMock<IServicoAcervoEmprestimo>();
            _useCase = mocker.CreateInstance<NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase>();
        }
        ...
        {
            Action acao = () => new NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase(
        ...
        public void DadoServicoNulo_QuandoInstanciarUseCase_EntaoLancaArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() =>
                new NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase(null!));
        }
        ...
        public async Task DadoMensagemValida_QuandoExecutar_EntaoRetornaTrueComSucesso()
        {
            ...
            _servicoAcervoEmprestimoMock
                .Setup(s => s.NotificarDevolucaoEmprestimoAtrasoProlongado())
        ...
        public async Task DadoMensagemValida_QuandoExecutar_EntaoChamaServicoNotificacaoUmaVez()
        {
            ...
            _servicoAcervoEmprestimoMock.Verify(
                s => s.NotificarDevolucaoEmprestimoAtrasoProlongado(),
                Times.Once);
        }
        ...
        {
            var mensagemRabbit = new MensagemRabbit { Mensagem = "Teste" };
            var mensagemErro = "Erro ao notificar devolução em atraso prolongado";
        ...
        {
            var useCase = new NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase(
                _servicoAcervoEmprestimoMock.Object);
        ...
        public async Task DadoInjecaoDependencia_QuandoExecutarComServicoMock_EntaoUsaMockCorreto()
        {
            ...
            var useCase = new NotificacaoDevolucaoEmprestimoAtrasoProlongadoUseCase(servicoMock.Object);
            var mensagemRabbit = new MensagemRabbit { Mensagem = "Teste" };
            ...
            resultado.Should().BeTrue();
            servicoMock.Verify(s => s.NotificarDevolucaoEmprestimoAtrasoProlongado(), Times.Once);
        }

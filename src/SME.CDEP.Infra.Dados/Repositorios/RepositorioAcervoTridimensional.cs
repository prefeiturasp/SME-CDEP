...
namespace SME.CDEP.Infra.Dados.Repositorios
{
    ...
    public class RepositorioAcervoTridimensional : RepositorioBase<AcervoTridimensional>, IRepositorioAcervoTridimensional
    {
        ...
        public async new Task<AcervoTridimensionalCompleto> ObterPorId(long id)
        {
        ...
        private async new Task<AcervoTridimensionalDetalhe> ObterPorCodigo(string codigo)
        {
            var query = @"select  at.id,
                        ...
                        where not a.excluido 
	                      and not c.excluido
                          and a.codigo = @codigo ";
            return await conexao.Obter().QueryFirstOrDefaultAsync<AcervoTridimensionalDetalhe>(query, new { codigo });
        }

...
namespace SME.CDEP.Infra.Dados.Repositorios
{
    ...
    public class RepositorioAcervoBibliografico : RepositorioBase<AcervoBibliografico>, IRepositorioAcervoBibliografico
    {
        ...
        private async new Task<AcervoBibliograficoDetalhe> ObterPorCodigo(string codigo)
        {
            var query = @"select  ab.id,
                                  a.id as AcervoId,
                                  a.titulo,
                        ...
                        where not a.excluido  
                        and a.codigo = @codigo ";
            return await conexao.Obter().QueryFirstOrDefaultAsync<AcervoBibliograficoDetalhe>(query, new { codigo });
        }

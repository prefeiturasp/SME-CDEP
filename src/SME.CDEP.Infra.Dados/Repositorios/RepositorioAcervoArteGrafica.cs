...
namespace SME.CDEP.Infra.Dados.Repositorios
{
    ...
    public class RepositorioAcervoArteGrafica : RepositorioBase<AcervoArteGrafica>, IRepositorioAcervoArteGrafica
    {
        ...
        public new async Task<IEnumerable<AcervoArteGrafica>> ObterTodos()
        {
        ...
        public new async Task<AcervoArteGraficaCompleto?> ObterPorId(long id)
        {
            try
            {
        ...
        private async Task<AcervoArteGraficaDetalhe> ObterPorCodigo(string codigo)
        {
            var query = @"select ag.id,
                        ...
                        and not su.excluido 
                        and a.codigo = @codigo ";
            return await conexao.Obter().QueryFirstOrDefaultAsync<AcervoArteGraficaDetalhe>(query, new { codigo });
        }

...
namespace SME.CDEP.Aplicacao.Servicos
{
    public class ServicoAcervoTridimensional : ServicoAcervoBase,IServicoAcervoTridimensional
    {
        ...
        private static string ObterCodigoAcervo(string codigo)
        {
        ...
        private static void ValidarPreenchimentoAcervoTridimensional(long[]? creditosAutoresIds, string? altura, string? largura, string? diametro, string? profundidade)
        {

...
namespace SME.CDEP.Aplicacao.Servicos
{
    public class ServicoUsuario : IServicoUsuario
    {
        ...
        private static void ValidarUsuarioExterno(Usuario usuario)
        {
            if (usuario.EhNulo())
        ...
        private static void ValidarSenha(string senhaNova, string confirmarSenha)
        {
        ...
        {
            return await servicoAcessos.ObterUsuariosComPerfisResponsavel(
                [

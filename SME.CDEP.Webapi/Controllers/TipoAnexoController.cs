...
public class TipoAnexoController: BaseController
{
    ...
    [Authorize("Bearer")]
    public async Task<IActionResult> CadastrarAlterar([FromBody] IdNomeExcluidoDTO tipoAnexoExcluidoDto, [FromServices] IServicoTipoAnexo servicoTipoAnexo)
    {
        return tipoAnexoExcluidoDto.Id > 0 ? Ok(await servicoTipoAnexo.Alterar(tipoAnexoExcluidoDto)) : Ok(await servicoTipoAnexo.Inserir(tipoAnexoExcluidoDto));
    }

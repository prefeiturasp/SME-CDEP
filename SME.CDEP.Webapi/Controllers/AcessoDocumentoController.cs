...
public class AcessoDocumentoController: BaseController
{
    ...
    [Authorize("Bearer")]
    public async Task<IActionResult> CadastrarAlterar([FromBody] BaseComNomeDTO acessoDocumentoDTO, [FromServices] IServicoAcessoDocumento servicoAcessoDocumento)
    {

    ...
    public class DominioParaDTOProfile : Profile
    {
        public DominioParaDTOProfile()
        {
            ...
            CreateMap<AcervoSolicitacaoItemCompleto,AcervoSolicitacaoItemRetornoCadastroDTO>()
                ...
                .ForMember(dest => dest.AlteraDataVisita, opt => opt.MapFrom(o => o.Situacao.EstaAguardandoVisita() && o.TipoAtendimento.EhAtendimentoPresencial()))
                .ReverseMap();
            ...
            CreateMap<AcervoSolicitacao,AcervoSolicitacaoManualCadastroDTO>().ReverseMap();
            CreateMap<AcervoSolicitacaoItem,AcervoSolicitacaoItemManualCadastroDTO>().ReverseMap();
        }            
    }
}

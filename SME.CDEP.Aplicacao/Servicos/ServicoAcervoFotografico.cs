...
namespace SME.CDEP.Aplicacao.Servicos
{
    public class ServicoAcervoFotografico : IServicoAcervoFotografico
    {
        ...
        public async Task<AcervoFotograficoDTO> Alterar(AcervoFotograficoDTO acervoFotograficoDto)
        {
            ...
            {
                Titulo = acervoFotograficoDto.Acervo.Titulo,
                Codigo = acervoFotograficoDto.Acervo.Codigo,
                CreditoAutorId = acervoFotograficoDto.Acervo.CreditoAutorId,
            ...
            if (retornoAcervo != null)
            {
                ...
                entidadeExistente = mapper.Map<AcervoFotografico>(acervoFotograficoDto);

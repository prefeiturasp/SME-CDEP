...
namespace SME.CDEP.Aplicacao.Servicos.Interface
{
    public interface IServicoAcervo : IServicoAplicacao,IServicoAcervoTipo,IServicoPesquisaAcervo, IServicoTipoAcervoPermitido
    {
        ...
        Task<PaginacaoResultadoDTO<IdTipoTituloCreditoAutoriaCodigoAcervoDTO>> ObterPorFiltro(int? tipoAcervo, string titulo, long? creditoAutorId, string codigo, int? idEditora);
